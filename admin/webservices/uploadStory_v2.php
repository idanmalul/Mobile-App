...
$query = "SELECT s.*,u.username,u.password FROM story s INNER JOIN story_user su ON su.story_id=s.id INNER JOIN users u ON u.user_id=su.user_id WHERE su.user_id='$user_id' AND su.story_id='$story_id' AND su.id='$sent_primary_id'";
