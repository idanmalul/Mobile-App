...
<div class="panel panel-default">
    <div class="panel-heading">
        <div class="panel-title">
            <?php if(!empty($campaign_detail)) echo 'Edit'; else echo 'Add'; ?> Static Campaign
        </div>
    </div>
        
    <div class="panel-body">
        <form action="<?php if(!empty($campaign_detail)) echo site_url('admin/edit_static_campaign'); else echo site_url('admin/add_static_campaign'); ?>" role="form" id="form1" name="form1" method="post" enctype="multipart/form-data" class="validate">
...
<!--            <div class="form-group">
				...
				<?php $get_country = get_all_country(); foreach ($get_country as $value) { ?>
                                <option value="<?php echo $value->country_code; ?>"><?php echo $value->country_name.' ('.get_timezone_by_country_code($value->country_code).')'; ?></option>
				<?php } ?>
				</select>
