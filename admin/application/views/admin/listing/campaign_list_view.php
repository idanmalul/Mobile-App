...
<div class="panel panel-default">
    ...
    <div class="panel-heading">
        ...
        <div class="panel-options">
             <a href="<?php echo site_url('admin/add_campaign'); ?>" class="btn btn-turquoise" style="color: #fff;">
                Add New Campaign
            </a>  
                ...
                <?php if (!empty($campaign_list)) {
                    ...
                    foreach ($campaign_list as $value) {
                        ...
                        <tr>
                         ...
                         <a href="<?php echo site_url('admin/edit_campaign') . '/' . $value->id; ?>" class="btn btn-blue btn-sm btn-icon icon-left" data-toggle="tooltip" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></a><br><br> 
                         
<a onClick="if(!confirm('Are you sure, You want to delete this campaign?')){return false;}" href="<?php echo site_url('admin/delete') . '/delete_campaign/campaign/id/' . $value->id; ?>" class="btn btn-danger btn-sm btn-icon icon-left" data-toggle="tooltip" data-placement="right" title="Delete"><i class="fa fa-trash"></i></a><br><br>
                                
                                <a href="<?php echo site_url('admin/campaign_detail_list') . '/' . $value->id; ?>" class="btn btn-blue btn-sm btn-icon icon-left" data-toggle="tooltip" data-placement="right" title="View Campaign Details"><i class="fa fa-eye" aria-hidden="true"></i>
									</a>
                            </td>
