...
<!--                                <td style="width: 2px !important;" >
                                ...
                                <td style="width: 10%">
                            <?php  if(!empty($value->profile_pic_url)){ ?>
                        
                        <!--<a href="#" class="pop">-->
                            <?php //if(is_array(getimagesize($value->profile_pic_url))) { ?>
    <img src="<?php echo $value->profile_pic_url; ?>" style="width: 70px; height: 70px;">
     <?php //} ?>
<!--</a>-->
                        <?php } ?>
  ...
  <div class="modal-dialog modal-sm">
      ...
      <div class="modal-body">
      	<button type="button" class="close_image" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
...
<!--                                <td style="width: 15px !important;" ><?php //if(!empty($favourite_list)) echo $favourite_list[0]->favourite_name; ?></td>-->
                                ...
                                <td style="width: 10px !important;"><?php echo (!empty($value->paypal_email)) ? 'Yes' :'No'; ?></td>
                                <td>
                                    
                                    <a href="<?php echo site_url('admin/edit_user') . '/' . $value->user_id; ?>" class="btn btn-blue btn-sm btn-icon icon-left" data-toggle="tooltip" data-placement="right" title="Edit"><i class="fa fa-pencil"></i></a>
                                </td>
