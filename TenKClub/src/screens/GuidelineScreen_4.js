...
export default class GuidelineScreen_4 extends Component {
    constructor(props){
        super(props)
        this.state = {
    ...
    render() {
        return (
            <ImageBackground source={Images.guideline_screen_4}  resizeMode="stretch" style={styles.container}>
                ...
                {/* <KeyboardAvoidingView behavior='padding' style={styles.container}> */}
                    {/* <TouchableWithoutFeedback style={styles.container}  */}
						...
						<Spinner />
                            ...
                            <TouchableOpacity 
                            onPress={() => this.props.navigation.navigate('GuidelineScreen_5')}>
