/*
twoFactorOTPVerification Screen
*/
...
export default class twoFactorOTPVerification extends Component {
    constructor(props){
        super(props)
        this.state = {
      ...
      getUserDetail = ()=>{
        ...
        async verifyOTP() {
          ...
          //    return false;
              ...
              // alert(fcmToken);
              // return false;
              let formBody="user_id="+challenge_user_id+"&verification_code="+this.state.verificationCode+"&gcm_id="+fcmToken+"&device_name="+""+"&two_factor_type=1"+"";
              // setTimeout(() => {
              //     this.setState({ isLoading: false });
              //   }, 15000);
             fetch(
                            ...
                            setTimeout(() => {
                              Alert.alert(
                                  ...
                                  //  {text: 'Cancel', onPress: () => console.log('Cancel Pressed'), style: 'cancel'},
                                    {text: 'OK', onPress: () => onAlertMessageOk()},
                                  ],
                                  { cancelable: false }
                                )
                           }, 100);
                        ...
                        <View style={styles.logoContainer}>
                            ...
                            <View style={styles.logoContainer}>
                               ...
                               <Image style={styles.logo}
                                ...
                                <Text style={styles.text_register}>2-Step OTP verification</Text> 
