...
export default class GuidelineScreen_2 extends Component {
    constructor(props){
        super(props)
        this.state = {
    ...
    render() {
        return (
            <ImageBackground source={Images.guideline_screen_2}  resizeMode="stretch" style={styles.container}>
                ...
                {/* <KeyboardAvoidingView behavior='padding' style={styles.container}> */}
                    {/* <TouchableWithoutFeedback style={styles.container}  */}
                        ...
                        {/* <View style={styles.logoContainer}>
                            ...
                            <View style={styles.logoContainer}>
                               ...
                               <Image style={styles.logo}
                                ...
                                <Text style={styles.text_login}> Guideline Screen - 2</Text> 
                            </View>
						...
						<Spinner />
                            ...
                            <TouchableOpacity 
                            onPress={() => this.props.navigation.navigate('GuidelineScreen_3')}>
